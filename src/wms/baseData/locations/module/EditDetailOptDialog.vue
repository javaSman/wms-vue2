...
export default {
  ...
  props: {
    ...
    Source: { type: String, require: true, default: '10' }, //查看打印记录的查询条件
    SourceSysNo: { type: String, require: true, default: '' } //查看打印记录的查询条件
  },
  data() {
    return {
  ...
  watch: {
    dialogFormVisible() {
      this.listQuery.SourceSysNo = this.SourceSysNo
      this.listQuery.Source = this.Source
      this.getList()
    }
  },
  computed: {
