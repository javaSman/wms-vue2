export default {
  route: {
    ...
    areas: '区域管理',
    warehouse: '仓库管理',
    SAPWarehousePermission: 'sap仓库权限管理',
    units: '单位管理',
    locations: '货位管理',
    wharf: '码头管理',
    device: '设备管理',
    ...
    // AGV配送管理
    agvManagement: '一期后勤AGV任务管理',
    agvPickOrderDetailAdm: '领料单明细管理',
    agvTaskAdm: '任务管理',
    // 四期AGV任务管理
    fourDataagvManagement: '四期AGV任务管理',
    callAGVWarehousing: '层高管理',
    FouragvTask: '任务管理',

    // 雄韬AGV任务管理
    xiongtaoAGVTask: '雄韬AGV任务管理',
    AGVTask: '任务管理',
    // 策略管理
    StrategyAdm: '策略管理',
    ...
    lockManagement: '锁库管理',
    handoverList: '交接清单',
    warehousingReport: '入库报表',
    outboundReport: '出库报表',
    cardBoardHandover: '卡板交接报表',
    receiptReport: '收货报表',
    emptyReport: '空托盘报表',
    inventoryVarianceReport: '库存差异报表',
  ...
  dialogHeader: {
    ...
    handoverListDetail: '交接清单明细',
    SAPWarehousePermission: 'Sap仓库权限'
    // *****业务****
  },
  // 提示
  notify: {
