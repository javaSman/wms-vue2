<template>
  <div class="login-container">
    ...
    >
      ...
      <div style="width: 600px; height: 40px; font-size: 14px; font-family: '黑体'">
        一、开通系统账号/权限,需提交OA_系统用户权限申请单
      </div>
      <div style="width: 600px; height: 40px; font-size: 14px; font-family: '黑体'">
        二、自助修改密码路径: 【钉钉】->【工作台】->【各系统密码重置】
      </div>
      <div style="width: 400px; height: 30px; font-size: 12px; margin-top: 5%; text-align: center">
        ©2023广东利元亨智能装备股份有限公司
      </div>
    </el-form>
  </div>
...
.login-container {
  min-height: 100%;
  width: 100%;
  background: url('../../../static/image/common/bg.png') no-repeat;
  ...
  .login-form {
    ...
    width: 1600px;
    height: 700px;
    padding: 200px 600px 0;
    margin: 6% auto;
    overflow: hidden;
    background: #ffffffd9;
    box-shadow: 0 0 20px 0px #9e9e9e59;
