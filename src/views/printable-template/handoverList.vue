    ...
    <table cellspacing="0" cellpadding="0" class="table">
      <thead>
        <tr class="col_design">
          ...
          <td style="width: 21mm" />
          <td style="width: 18mm" />
          <td style="width: 60mm; overflow: hidden; white-space: nowrap; text-overflow: ellipsis" />
          <td style="width: 23mm" />
          <td style="width: 21mm" />
          <td style="width: 30mm" />
          <td style="width: 46mm" />
        ...
        <tr class="top-title">
          ...
          <td colspan="3" style="border-bottom: none !important">物料类别：{{ thead.MaterialType }}</td>
          <td colspan="3" style="border-bottom: none !important">发出区域：{{ thead.OriginArea }}</td>
          <td colspan="2" rowspan="2" style="border-bottom: none !important">
            条码：
...
export default {
  ...
  methods: {
    creatBarCode() {
      jsbarcode('#barcode', this.data[0].orderNo, {
        width: 2.5,
        displayValue: false
      })
    }
