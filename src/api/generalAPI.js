...
// import requestThree from '@/utils/requestThree'
function commonAPI(router, requestParam) {
  // const request = requestParam ? requestTwo : requestThree
...
// export const newAPI = commonAPI('business', 'requestThree') // 业务路由
