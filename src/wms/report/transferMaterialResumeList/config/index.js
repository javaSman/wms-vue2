...
export const queryItems = [
  ...
  { type: 'Input', label: '目标条码', prop: 'TargetBarcode' },
  { type: 'Input', label: '目标箱子号', prop: 'TargetBoxID' },
  { type: 'Input', label: '目标货位', prop: 'TargetLocationID' },
