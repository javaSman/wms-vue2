...
export default {
  ...
  data() {
    return {
      colName: 'CardBoardHandoverReportDto',
      apiName: 'CardBoardHandoverReport',
      outboundReportItems,
      isEdit: true,
      BtnItems,
    ...
    handleDownloadPast() {
      ...
      if (this.list === null) {
        ...
        if (this.multipleSelection.length > 0) {
          ...
          this.exportPast('CardBoardHandoverReport', { Ids: Ids }, 'Export', true)
        } else {
          this.exportPast('CardBoardHandoverReport', this.exportParams, 'Export', true)
        }
      }
    }
  }
