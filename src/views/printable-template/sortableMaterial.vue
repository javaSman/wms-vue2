      ...
      <tbody>
        <tr>
          ...
          <td style="width: 40%" rowspan="3" valign="top">
            ...
            <div ref="qrcode333" class="qrcodestyle" />
            <div class="textSt">{{ data[0].Barcode }}</div>
          </td>
        ...
        <tr>
          ...
          <td style="height: 28mm" valign="top">
            <div class="text">
              制单号：{{ data[0].OrderID }}
              <br />
              备料单：{{ data[0].ReadyMaterialsID }}
              <br />
              <!-- 计划：{{ data[0].Plan }}
              <br /> -->
              生产批： {{ data[0].BatchID }}&nbsp;{{ data[0].StationID }}
              <br />
              QTY：{{ data[0].Qty }}&nbsp;&nbsp;&nbsp;{{ data[0].UnitID }}
              <br />
              领料人：{{ data[0].Recipient }}-{{ data[0].PrepareArea }}
              <br />
